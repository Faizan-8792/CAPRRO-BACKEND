...
// collection there is no live connection to here. This suite tests coverage
// and discipline, not quota, so the increment is stubbed to always succeed --
// see tests/provider-quota-contract.mjs for the quota logic itself.
